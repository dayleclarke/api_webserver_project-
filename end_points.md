...
![Auth Routes](docs/auth_routes.jpg)
...
```
![User Routes](docs/user_routes.png)
...
```
![Student Routes](docs/student_routes.png)
...
![Address Routes](docs/address_routes.png)
...
```
![Subject Routes](docs/subject_routes.png)
...
```
![Subject Class Routes](docs/subject_class_routes.png)
## Enrollment Routes
...
![Student Relations Routes](docs/student_relations_routes.jpg)
